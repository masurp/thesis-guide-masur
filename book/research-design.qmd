...
| **Output** | Generalizable findings across populations | Rich, contextualized insights |
| **Thesis structure** | Hypotheses + conceptual model | Sub-questions |

Both approaches are valid in Communication Science. The choice depends on your research question and the state of knowledge in your area.
...
**Key considerations:**
- Sample size and recruitment (specify power analysis rationale)
...
This plan prevents ad-hoc analysis decisions later. In the final thesis, the analysis plan is not a separate chapter — it is integrated into the Results section.

::: {.callout-tip}
## Pre-registration
Consider pre-registering your analysis plan on the Open Science Framework (OSF) before data collection. See [Open Science](open-science.qmd) for details.
:::
